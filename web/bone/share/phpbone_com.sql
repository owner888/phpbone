...
CREATE TABLE `bone_catalog_model` (
  ...
  PRIMARY KEY  (`cmid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='分类数据模型';
...
CREATE TABLE `bone_catalog_doc` (
  ...
  PRIMARY KEY  (`cid`),
  KEY `cmid` (`cmid`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='分类数据表';

CREATE TABLE `bone_doc` (
  `doc_id` int(11) NOT NULL auto_increment COMMENT '文档id',
  `cid` smallint(5) unsigned NOT NULL default '0' COMMENT '文档分类@catalog-2@',
  `flag` set('c','h','f','s','a','x','y','z') NOT NULL default '' COMMENT '文档属性',
  `sta` tinyint(2) NOT NULL default '1' COMMENT '文档状态',
  `title` varchar(100) NOT NULL default '' COMMENT '文档标题',
  `add_title` varchar(100) NOT NULL default '' COMMENT '附加标题',
  `thumb` varchar(100) NOT NULL default '' COMMENT '缩略图@image@',
  `author` varchar(30) NOT NULL default '' COMMENT '作者',
  `source` varchar(50) NOT NULL default '' COMMENT '来源',
  `keyword` varchar(50) NOT NULL default '' COMMENT '关键字',
  `description` varchar(150) NOT NULL default '' COMMENT '内容摘要',
  `pubtime` int(11) NOT NULL default '0' COMMENT '发布时间',
  `uptime` int(11) NOT NULL default '0' COMMENT '最后修改时间',
  `addtime` int(11) NOT NULL default '0' COMMENT '录入时间',
  `admin_id` smallint(5) unsigned NOT NULL default '0' COMMENT '管理员id',
  `edit_admin` smallint(5) unsigned NOT NULL default '0' COMMENT '最后修改人',
  `hits` int(11) NOT NULL default '0' COMMENT '总点击',
  `week_hits` int(11) NOT NULL default '0' COMMENT '周点击',
  `sortrank` smallint(5) unsigned NOT NULL default '0' COMMENT '自定义排序值',
  PRIMARY KEY  (`doc_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='简易帮助文档';

CREATE TABLE `bone_doc_body` (
  `doc_id` int(11) NOT NULL default '0' COMMENT '文档id',
  `cid` smallint(6) NOT NULL default '0' COMMENT '文档分类',
  `body` mediumtext NOT NULL COMMENT '文档内容',
  UNIQUE KEY `doc_id` (`doc_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='文档内容';

INSERT INTO `bone_catalog_model` (`cmid`, `cmname`, `cmtable`, `sortrank`, `showmenu`, `adm_url`, `delopt`) VALUES('3', '帮助文档', 'doc', 997, 0, '?ct=doc_catalog', 0);

INSERT INTO `bone_catalog_model` (`cmid`, `cmname`, `cmtable`, `sortrank`, `showmenu`, `adm_url`, `delopt`) VALUES('4', '文档属性', 'base', 90, 0, '', 0);

INSERT INTO `bone_catalog_base` (`cid`, `cmid`, `pid`, `cname`, `sortrank`, `ico`) VALUES(15, '4', 0, '推荐', 99, 'c');

INSERT INTO `bone_catalog_base` (`cid`, `cmid`, `pid`, `cname`, `sortrank`, `ico`) VALUES(16, '4', 0, '头条', 98, 'h');

INSERT INTO `bone_catalog_base` (`cid`, `cmid`, `pid`, `cname`, `sortrank`, `ico`) VALUES(17, '4', 0, '幻灯', 97, 'f');

INSERT INTO `bone_catalog_base` (`cid`, `cmid`, `pid`, `cname`, `sortrank`, `ico`) VALUES(18, '4', 0, '滚动', 96, 's');

INSERT INTO `bone_catalog_base` (`cid`, `cmid`, `pid`, `cname`, `sortrank`, `ico`) VALUES(19, '4', 0, '特荐', 95, 'a');

INSERT INTO `bone_catalog_base` (`cid`, `cmid`, `pid`, `cname`, `sortrank`, `ico`) VALUES(20, '4', 0, '属性', 94, 'x');

INSERT INTO `bone_catalog_base` (`cid`, `cmid`, `pid`, `cname`, `sortrank`, `ico`) VALUES(21, '4', 0, '属性', 93, 'y');

INSERT INTO `bone_catalog_base` (`cid`, `cmid`, `pid`, `cname`, `sortrank`, `ico`) VALUES(22, '4', 0, '属性', 92, 'z');

CREATE TABLE `bone_member` (
  `member_id` smallint(5) unsigned NOT NULL auto_increment COMMENT '会员id',
  `user_name` varchar(20) default NULL COMMENT '用户名',
  `userpwd` char(32) default NULL COMMENT '用户密码',
  `email` varchar(50) NOT NULL COMMENT '邮箱',
  `pools` varchar(20) default NULL COMMENT '权限池',
...
INSERT INTO `bone_config` (`sort_id`, `name`, `title`, `info`, `group_id`, `type`, `value`) VALUES(0, 'member_df_purview', '会员默认权限配置', '', 0, 'text', '<pools:member name="会员" allowpool="member" auttype="cookie" login_control="?ct=index&ac=login">\r\n\r\n    <!—— //公开的控制器，不需登录就能访问 ——>\r\n    <ctl:public>index-login,index-reg,index-loginout,index-validate_image</ctl:public>\r\n\r\n    <!—— //保护的控制器，当前池会员登录后都能访问 ——>\r\n    <ctl:protected>index-index,index-editinfos</ctl:protected>\r\n\r\n    <!—— //私有控制器，只有特定组才能访问 ——>\r\n    <ctl:private>\r\n        <common name="普通会员">*</common>\r\n        <advanced name="高级会员">*</advanced>\r\n    </ctl:private>\r\n\r\n</pools:member>\r\n');
CREATE TABLE `bone_ads` (
  `id` int(11) NOT NULL auto_increment COMMENT '编号',
  `show` tinyint(1) unsigned NOT NULL default '1' COMMENT '是否启用',
  `key` varchar(20) NOT NULL default '' COMMENT '标识',
  `info` varchar(100) NOT NULL default '' COMMENT '备注',
  `code` text NOT NULL COMMENT '代码',
  `expcode` text NOT NULL COMMENT '禁用后显示内容',
