...
class cls_analysis
{
    ...
    public $addonDicFile = 'words_addons.dic';
    ...
    public $mainDicFile = 'base_dic_full.dic';
     ...
     * @return void
     */
    public function __construct($source_charset='utf-8', $target_charset='utf-8', $source='')
    {
        $this->addonDicFile = PATH_SHARE.'/phpana_dict/'.$this->addonDicFile;
        $this->mainDicFile  = PATH_SHARE.'/phpana_dict/'.$this->mainDicFile;
